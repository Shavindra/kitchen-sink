...
import React, { CSSProperties, MouseEventHandler, ReactElement, useEffect } from 'react'
import {
  Cell,
  ColumnInstance,
  HeaderGroup,
...
function DefaultColumnFilter<T extends Record<string, unknown>>({ columns, column }: any) {
...
export function Table(props: any): ReactElement {
  ...
  const cellClickHandler = (cell: Cell<any>) => () => {
